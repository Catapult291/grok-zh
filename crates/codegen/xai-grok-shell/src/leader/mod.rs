...
/// (e.g. the product data tree) — prefer the product-specific managed binary.
/// After an auto-update atomically swaps that path, `current_exe()`
...
/// calling binary.
///
/// Falls back to the product-specific managed binary only when
