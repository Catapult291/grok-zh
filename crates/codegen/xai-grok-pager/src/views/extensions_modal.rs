                ...
                if let TabDataState::Loaded(ref skills) = state.skills_data {
                    ...
                    for group_label in &group_order {
                        ...
                        entry_labels.push(if count == 1 {
                            ...
                            .replace("{source}", &localized_group)
                        } else {
                            extension_text(
                                locale,
                    ...
                    TabDataState::Loaded(ref workflows) => {
                        ...
                        if !visible.is_empty() {
                            ...
                            entry_labels.push(if count == 1 {
                                extension_static(
                                    locale,
                                    "extensions.workflows.group_count.one",
                                ...
                                extension_text(
                                    locale,
                                    "extensions.workflows.group_count.many",
                ...
                if let TabDataState::Loaded(ref data) = state.hooks_data {
                    ...
                    for group in &groups {
                        ...
                        entry_labels.push(
                            ...
                            .replace("{count}", &indices.len().to_string()),
                        );
                        entry_right_labels.push(String::new());
                        entry_desc_lines.push(vec![]);
                        entry_summary_lines.push(vec![]);
