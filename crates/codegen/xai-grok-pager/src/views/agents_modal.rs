    ...
    for (vi, ri) in (state.scroll..end).enumerate() {
        ...
        match &rows[ri] {
            ...
            FlatRow::Agent(idx) => {
                ...
                let (badge_text, mut badge_style) =
